...
internal class Program
{
    ...
    private static void ConstruireColis()
    {
        ...
        Colis col2 = new Colis("625 Av. Sainte-Croix, Saint-Laurent, QC H4L 3X7", "George", false);
        Colis col3 = new Colis("7000 Rue Marie-Victorin, Montréal, QC H1G 2J6", "Sara", true);
        ...
        for (int x = 1; x <= 5; x++)
        {
            ...
            Console.WriteLine("Colis#" + x + " " + col.GetNom() + " add=" + col.GetAdresse());
            if (col.GetClientAbscent() == false)
            {
                Console.ForegroundColor = ConsoleColor.DarkRed;
                Console.WriteLine(" Present:" + col.GetClientAbscent().ToString() + "\tRedirection:" + srv.GetAdresse());
                Console.ForegroundColor = ConsoleColor.Green;
            }
        }
    ...
    {
        Employe emp1 = new Employe(1, 35.35, "Divano", "St-Hyacinte");
        Employe emp2 = new Employe(2, 32.24, "Claudius", "Stratburgum");
        Employe emp3 = new Employe(3, 28.15, "Jurgie", "Rust");
        Employe emp4 = new Employe(4, 28.36, "Lala", "Bassel");
        ...
        if (idemploye > 0 && idemploye < 5)
        {
            ...
            Console.WriteLine("Ravi de vous revoir " + emp.GetNoEmploye() + "." + emp.GetNom() + "@" + emp.GetAdresse());
